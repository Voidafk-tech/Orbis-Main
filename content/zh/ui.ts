...
export const UI: Widen<typeof EnUI> = {
  ...
  hero: {
    ...
    headline: '账目准确',
    headlineEm: '申报及时',
    sub: 'GST 交给 CRA，PST 交给 BC省政府，每月另附一份看得懂的财务报表。全年由同一位专责人员处理您的账务，无需反复说明业务情况。',
    cta: '获取方案与报价',
  ...
  pains: {
    h2: '四项多数经营者正在承担的负担',
    lede: '经营一家企业，账务是唯一没有人事先替您安排好的部分',
  },
    ...
    taxes: [
      {
        ...
        name: 'GST',
        authority: '交给 CRA',
        body: '联邦税。连续四个季度营业额超过 3 万加元后即须注册。多数销售均须收取，为业务采购支付的 GST 可申报抵扣。',
      },
      {
  ...
  form: {
    ...
    sentPAfter: '，若您的邮箱过滤较严，请先将此地址加入白名单。',
    sentAgain: '再发送一份',
  },
  ...
  pricingPage: {
    ...
    headline: '代理记账',
    headlineEm: '的实际费用',
    sub: '我们按交易笔数收固定月费，不按小时计费。以下说明这一数字如何构成、受什么影响，以及市场上的普遍水平。',
    howEyebrow: '运作方式',
    howH2: '四项始终成立的原则',
    marketEyebrow: '市场行情',
  ...
  remotePage: {
    ...
    headline: '远程代理记账',
    headlineEm: '服务全 BC省',
    sub: '无需寄送资料，无需到访办公室，也不必让单据长期堆放在车内。账务每月由同一位专责人员在线上完成，无论您在西温哥华，还是在数小时车程之外。',
    howEyebrow: '实际运作方式',
    howH2: '四项安排 使递送资料不再必要',
    howLede:
      '现代账务的几乎每一个环节，本就已在线上进行。所谓「远程」，并不是在面对面流程上勉强加装的折衷办法。',
    ...
    areasLede:
      '整套做法本就不依赖地理位置，所在地不影响服务范围或价格。我们的客户遍及温哥华、素里、本拿比与列治文，远至维多利亚与基隆拿，也包括内陆、温哥华岛与北部地区。我们在西温哥华，这只是关于我们的一项事实，不构成对您的限制。',
    faqEyebrow: '常见问题',
    faqH2: '关于远程合作的疑问',
    faqIntroA: '其余问题请见',
    faqIntroLink: '主页',
  ...
  gstPstPage: {
    ...
    headline: '两种税',
    headlineEm: '两套规则',
    sub: 'GST 交给 CRA，PST 交给 BC省政府。两者分别注册、分别申报，对应税范围的界定也不一致。注册了其中一项，并不能说明另一项是否也要注册。',
    ratesEyebrow: '税率',
    ...
    ctaH2: '不确定已注册哪一项？',
    ctaP: '请在表格中说明。我们会对照您实际销售的内容核对两项注册，在书面报价中确认，之后才会办理任何申报。',
  },
  ...
  vsTaxPage: {
    ...
    sub: '每月账务包含什么、年终申报包含什么、两者在何处衔接，以及我们各承接到什么程度。这一行含糊其辞的说法太多，所以这里写明白。',
    rolesEyebrow: '各自包含什么',
    rolesH2: '工作如何划分',
  ...
  pstRegistrationPage: {
    ...
    headline: '在 BC省',
    headlineEm: '注册 PST',
    sub: '贵公司是否需要注册、BC省政府需要哪些材料，以及完成登记之后有何不同。PST 没有营业额门槛，它取决于您销售的内容。',
